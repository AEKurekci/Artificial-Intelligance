...
_CONSTRAINTSOLVERPARAMETERS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='disable_solve', full_name='operations_research.ConstraintSolverParameters.disable_solve', index=15,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='use_small_table', full_name='operations_research.ConstraintSolverParameters.use_small_table', index=16,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='use_cumulative_edge_finder', full_name='operations_research.ConstraintSolverParameters.use_cumulative_edge_finder', index=17,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='use_cumulative_time_table', full_name='operations_research.ConstraintSolverParameters.use_cumulative_time_table', index=18,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='use_cumulative_time_table_sync', full_name='operations_research.ConstraintSolverParameters.use_cumulative_time_table_sync', index=19,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='use_sequence_high_demand_tasks', full_name='operations_research.ConstraintSolverParameters.use_sequence_high_demand_tasks', index=20,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='use_all_possible_disjunctions', full_name='operations_research.ConstraintSolverParameters.use_all_possible_disjunctions', index=21,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='max_edge_finder_size', full_name='operations_research.ConstraintSolverParameters.max_edge_finder_size', index=22,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='diffn_use_cumulative', full_name='operations_research.ConstraintSolverParameters.diffn_use_cumulative', index=23,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='use_element_rmq', full_name='operations_research.ConstraintSolverParameters.use_element_rmq', index=24,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='skip_locally_optimal_paths', full_name='operations_research.ConstraintSolverParameters.skip_locally_optimal_paths', index=25,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='check_solution_period', full_name='operations_research.ConstraintSolverParameters.check_solution_period', index=26,
...
ConstraintSolverParameters = _reflection.GeneratedProtocolMessageType('ConstraintSolverParameters', (_message.Message,), {
