...
IntVarAssignment = _reflection.GeneratedProtocolMessageType('IntVarAssignment', (_message.Message,), {
...
IntervalVarAssignment = _reflection.GeneratedProtocolMessageType('IntervalVarAssignment', (_message.Message,), {
...
SequenceVarAssignment = _reflection.GeneratedProtocolMessageType('SequenceVarAssignment', (_message.Message,), {
...
AssignmentProto = _reflection.GeneratedProtocolMessageType('AssignmentProto', (_message.Message,), {
